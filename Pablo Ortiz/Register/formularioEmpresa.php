<?php
  ...
  if (!empty($_POST['email']) && !empty($_POST['password'])) {
    $sql = "INSERT INTO empresa (cargo, nombres, apellidos, contacto, email, password) VALUES (:cargo, :nombres, :apellidos, :contacto, :email, :password)";
...
<html lang='es'>
    ...
    <body>
        ...
        <?php
        require '../Partials/encabezado.php';
        ?>
        ...
        <form action = "formularioEmpresa.php" method = "POST">
            ...
            <div class="formulario">
                ...
                <p>Correo Electronico <input class="datos" type = "email" name = "email" placeholder = "Tu correo"></p>
                <p>Contraseña <input class="datos" type = "password" name = "password" placeholder = "Tu contraseña"></p>
                <p>Confirmacion de Contraseña <input class="datos" type = "password" name = "confirm_password" placeholder = "Confirma tu contraseña"></p>
